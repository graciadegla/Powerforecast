...
def guide():
   # Code de la page de détails
    ...
    st.write("""Les informations utilisées dans ce projet sont collectées à partir de la base des données de consommation électrique de 2017
                de la ville de Tétouan au Maroc. 
    ...
    st.write(" ***Affichage des 15 premières observations de la base de données***")
    #Charger la donnée
